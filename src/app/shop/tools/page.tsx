    ...
    return (
        <main className={styles.main}>
            <div className={`glass-container animate-float ${styles.heroContainer}`} style={{ maxWidth: '1200px', width: '100%' }}>
                ...
                {currentUserIsBoardOrAdmin && (
                    <div style={{ marginBottom: '2rem' }}>
                        {!showNewToolForm ? (
                            <button className="glass-button" onClick={() => setShowNewToolForm(true)} style={{ background: 'rgba(59, 130, 246, 0.2)', borderColor: 'rgba(59, 130, 246, 0.4)' }}>
                                + Create New Tool
                            </button>
                        ) : (
                                    ...
                                    {tools.map(tool => {
                                        ...
                                        return (
                                            <td key={tool.id} style={{ padding: '1rem 0.5rem', textAlign: 'center' }}>
                                                <select
                                                    value={currentLevel}
                                                    disabled={saving || !currentUserIsStewardOrAdmin}
